...
#define UE_PROJECT_NAME Game_Prototype_1
#define UE_TARGET_NAME Game_Prototype_1Editor
#define UE_MODULE_NAME "Game_Prototype_1"
...
#define GAME_PROTOTYPE_1_API DLLEXPORT
